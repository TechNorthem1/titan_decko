  ...
  return (
    <div>
      ...
      <p>
        ...
        <strong>NORTHEM GROUP IMPORT &amp; EXPORT </strong>
        <strong>SAS.</strong> En todo el sitio, los términos “nosotros”, “nos” y
        “nuestro” se refieren a 
        <strong>
          NORTHEM GROUP IMPORT &amp; EXPORT SAS. NORTHEM GROUP IMPORT &amp;
          EXPORT SAS 
        </strong>
        ofrece este sitio web, incluyendo toda la información, herramientas y
        servicios disponibles para ti en este sitio, el usuario, está
      ...
      <p>
        ...
        incluyendo si limitación a usuarios que sean navegadores, proveedores,
      ...
      <p>
        ...
        aceptación está expresamente limitada a estos
        <br />
      ...
      <p>
        ...
        continuó o el acceso al sitio web después de la publicación de cualquier
      ...
      <p>
        ...
        (<strong>18 años Para la republica de Colombia</strong>) y que nos has
        dado tu consentimiento para permitir que cualquiera de tus dependientes
      ...
      <p>
        Nos reservamos el derecho de modificar o discontinuar el  productos o
        Servicio (o cualquier parte del contenido) en cualquier momento sin
        aviso previo.
      </p>
      ...
      <p>
        Nos reservamos el derecho de limitar las cantidades de los productos o
        servicios que ofrecemos.  Todas las descripciones de productos o precios
        de los productos están sujetos a cambios en cualquier momento sin previo
        aviso, a nuestra sola discreción. 
      </p>

      <p>
        Nos reservamos el derecho de
        <br />
        descontinuar cualquier producto en cualquier momento.  Cualquier oferta
        de producto o servicio hecho en este sitio es nulo donde esté prohibido.
      </p>
      ...
      <p>
        ...
        momento que se hizo pedido.
      </p>

      <p>
        Nos reservamos el derecho de limitar o prohibir las órdenes que, a
        nuestro juicio, parecen ser colocado por los concesionarios,
      ...
      <p>
        ...
        transacción. 
        <br />
        Quejas, reclamos, inquietudes o preguntas con respecto a productos de
      ...
      <p>
        ...
        manera, afectar el funcionamiento del Servició o de cualquier sitio web
        relacionado. 
      </p>

      <p>
        No puedes utilizar una dirección de correo electrónico falsa, usar otra
        identidad que no sea legítima, o engañar a terceras partes o a nosotros
        en cuanto  al origen de tus comentarios.  Tu eres el único responsable
        por los comentarios que haces y su precisión.  No nos hacemos
        responsables y no asumimos ninguna obligación con respecto a los
      ...
      <p>
        ...
        Nos reservamos el
        <br />
        derecho de suspender el uso del Servicio o de cualquier sitio web
      ...
      <p>
        Aceptas expresamente qué el uso de, o la posibilidad de utilizar, el
        ...
        <br />o condiciones implícitas de comercialización, calidad
        comercializable, la aptitud para un propósito particular, durabilidad,
        título y no infracción.
      </p>

      <p>
        En ningún caso <strong>NORTHEM GROUP IMPORT &amp; EXPORT SAS</strong>,
        ...
        la exclusión o la limitación de
        <br />
        responsabilidad por daños consecuenciales o incidentales, en tales
        estados o jurisdicciones, nuestra responsabilidad se limitará en la
      ...
      <p>
        Aceptas indemnizar, defender y mantener indemne 
        <strong>NORTHEM GROUP </strong>
        <strong>IMPORT &amp; EXPORT SAS</strong> y nuestras matrices,
        ...
        tercero a causa o como resultado de tu incumplimiento de las Condiciones
        de Servicio o de los documentos que incorporan como referencia, o la
      ...
      <p>
        ...
        podemos negarte el acceso
        <br />a nuestros servicios (o cualquier parte del mismo).
      </p>
      ...
      <p>
        ...
        constituyen el acuerdo completo y el entendimiento entre tu y nosotros y
      ...
      <p>
        ...
        las leyes de  la Republica de Colombia.
      </p>

      <p>
        Este acuerdo será regulado por las leyes colombianas. Cualquier
        desavenencia surgida entre las Partes con motivo de la ejecución o
        interpretación de los presentes términos y condiciones será resuelta por
        arreglo directo entre las partes. Si esto no fuese posible, la
        desavenencia será sometida al proceso de conciliación que regula la ley
        640 de 2001 y demás normas complementarias y concordantes. El conflicto
        se someterá al proceso mencionado con la intervención de un conciliador
        nombrado por la Cámara de Comercio de Bogotá. La decisión del
        conciliador será obligatoria para las partes. En caso de no llegar a un
        Acuerdo de Conciliación, las diferencias serán sometidas a la
        jurisdicción ordinaria. Los honorarios y expensas asociados con el
        proceso judicial que llegase a adelantarse serán pagados por la Parte
        que no fuere favorecida.
      </p>
      ...
      <p>
        ...
        periódicamente para verificar los cambios. El uso continuó de o el
      ...
      <p>
        ...
        <em>
          a <strong>info@titandecko.com.co</strong>
        </em>
      </p>
    </div>
  );
